...
public:
    ...
    void setupUi(QDialog *CatchmentPolygon)
    {
        ...
        groupBoxInput_2->setGeometry(QRect(16, 106, 581, 111));
        QFont font1;
        font1.setBold(false);
        font1.setWeight(50);
        ...
        pushButtonCatchmentPolygon->setGeometry(QRect(480, 10, 98, 32));
        ...
        lineEditCatchmentPolygon->setGeometry(QRect(7, 47, 571, 29));
        QFont font3;
        ...
        checkBoxCatchmentPolygon->setGeometry(QRect(484, 81, 91, 21));
        QFont font4;
        ...
        textBrowserLogs->setGeometry(QRect(16, 276, 581, 121));
        QFont font5;
        ...
        groupBoxButtons->setGeometry(QRect(16, 221, 581, 51));
        ...
        pushButtonClose->setGeometry(QRect(326, 4, 113, 32));
        ...
        textLabel1->setGeometry(QRect(230, 10, 131, 31));
        ...
        lineEditCatchmentGrids->setGeometry(QRect(7, 44, 571, 29));
