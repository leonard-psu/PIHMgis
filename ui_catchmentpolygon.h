...
public:
    ...
    void setupUi(QDialog *CatchmentPolygon)
    {
        ...
        groupBoxInput_2->setGeometry(QRect(16, 117, 581, 111));
        ...
        lineEditCatchmentPolygon->setGeometry(QRect(10, 50, 561, 29));
        QFont font1;
        font1.setPointSize(14);
        font1.setBold(true);
        font1.setWeight(75);
        lineEditCatchmentPolygon->setFont(font1);
        ...
        checkBoxCatchmentPolygon->setGeometry(QRect(490, 90, 91, 21));
        QFont font2;
        ...
        checkBoxCatchmentPolygon->setFont(font2);
        ...
        textLabel1->setGeometry(QRect(230, 10, 111, 31));
        ...
        lineEditCatchmentGrids->setGeometry(QRect(9, 45, 561, 29));
        lineEditCatchmentGrids->setFont(font1);
