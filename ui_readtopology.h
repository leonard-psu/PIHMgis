...
public:
    ...
    void setupUi(QDialog *ReadTopology)
    {
        ...
        textBrowserLogs->setGeometry(QRect(13, 285, 581, 101));
        ...
        groupBoxButtons->setGeometry(QRect(20, 210, 581, 61));
