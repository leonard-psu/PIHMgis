...
{
    if(print_debug_messages)
        qDebug() << "INFO: Start OpenProject::on_pushButtonFile_clicked()";
    ...
    try {
        ...
        qDebug() << "Error: OpenProject::on_pushButtonFile_clicked()";
    }
}
...
void OpenProject::on_pushButtonClose_clicked()
{
    ...
    try {
        ...
        qDebug() << "Error: OpenProject::on_pushButtonClose_clicked()";
    }
}
...
{
    if(print_debug_messages)
        qDebug() << "INFO: Start OpenProject::on_pushButtonOpen_clicked()";
    ...
    try {
        ...
        qDebug() << "Error: OpenProject::on_pushButtonOpen_clicked()";
    }
}
