...
public:
    ...
    void setupUi(QDialog *IbcDataFile)
    {
        ...
        textBrowserLogs->setGeometry(QRect(5, 140, 781, 161));
        QFont font1;
        ...
        groupBoxButtons->setGeometry(QRect(5, 93, 781, 41));
        ...
        BorderBottom->setGeometry(QRect(0, 310, 800, 20));
        ...
        groupBoxOutput->setGeometry(QRect(5, 13, 781, 81));
        textLabel2 = new QLabel(groupBoxOutput);
        textLabel2->setObjectName(QStringLiteral("textLabel2"));
        textLabel2->setGeometry(QRect(330, 10, 131, 31));
        ...
        pushButtonIbcDataFile->setGeometry(QRect(680, 10, 98, 32));
        ...
        lineEditIbcDataFile->setGeometry(QRect(6, 45, 771, 29));
        QFont font3;
