...
public:
    ...
    void setupUi(QDialog *FlowGrids)
    {
        ...
        lineEditFillPits->setGeometry(QRect(14, 44, 561, 29));
        QFont font1;
        ...
        textLabel1->setGeometry(QRect(180, 10, 221, 31));
        QFont font2;
        font2.setBold(true);
        font2.setWeight(75);
        ...
        checkBoxFlowDirGrid->setFont(font3);
        ...
        textLabel1_2_2->setGeometry(QRect(230, 110, 111, 31));
        ...
        lineEditFlowDirGrids->setGeometry(QRect(14, 48, 561, 29));
        ...
        checkBoxFlowAccGrid->setFont(font3);
