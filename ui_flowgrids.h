...
public:
    ...
    void setupUi(QDialog *FlowGrids)
    {
        ...
        FlowGrids->resize(800, 480);
        FlowGrids->setMinimumSize(QSize(800, 480));
        FlowGrids->setMaximumSize(QSize(800, 480));
        QPalette palette;
        ...
        textLabel1->setGeometry(QRect(230, 10, 271, 31));
        ...
        groupBoxInput_2->setGeometry(QRect(15, 95, 771, 201));
        textLabel1_2 = new QLabel(groupBoxInput_2);
        textLabel1_2->setObjectName(QStringLiteral("textLabel1_2"));
        textLabel1_2->setGeometry(QRect(290, 10, 121, 31));
        ...
        checkBoxFlowDirGrid->setGeometry(QRect(660, 75, 101, 21));
        QFont font4;
        ...
        pushButtonFlowAccGrid->setGeometry(QRect(663, 110, 98, 32));
        ...
        lineEditFlowAccGrids->setGeometry(QRect(10, 145, 751, 29));
        ...
        textLabel1_2_2->setGeometry(QRect(290, 110, 121, 31));
        ...
        lineEditFlowDirGrids->setGeometry(QRect(10, 45, 751, 29));
        ...
        checkBoxFlowAccGrid->setGeometry(QRect(670, 177, 91, 21));
        ...
        pushButtonsFlowDirGrid->setGeometry(QRect(663, 10, 98, 32));
        ...
        pushButtonHelp->setGeometry(QRect(9, 7, 113, 32));
