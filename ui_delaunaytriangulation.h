...
public:
    ...
    void setupUi(QDialog *DelaunayTriangulation)
    {
        ...
        groupBoxOutput->setGeometry(QRect(15, 100, 581, 81));
        QFont font;
        ...
        lineEditAngle->setGeometry(QRect(21, 46, 141, 29));
        QFont font1;
        ...
        lineEditArea->setGeometry(QRect(180, 46, 231, 29));
        ...
        checkBoxArea->setGeometry(QRect(219, 23, 151, 20));
        ...
        checkBoxOthers->setGeometry(QRect(429, 23, 131, 20));
        ...
        lineEditOthers->setGeometry(QRect(429, 46, 131, 29));
        ...
        groupBoxButtons->setGeometry(QRect(10, 184, 581, 51));
        ...
        pushButtonClose->setGeometry(QRect(336, 10, 113, 32));
        pushButtonClose->setFont(font3);
        pushButtonClose->setAutoDefault(false);
        pushButtonRun = new QPushButton(groupBoxButtons);
        pushButtonRun->setObjectName(QStringLiteral("pushButtonRun"));
        pushButtonRun->setGeometry(QRect(461, 10, 113, 32));
        ...
        textBrowserLogs->setGeometry(QRect(13, 245, 581, 151));
        QFont font5;
        ...
        lineEditFIND->setGeometry(QRect(10, 50, 571, 29));
        QFont font7;
