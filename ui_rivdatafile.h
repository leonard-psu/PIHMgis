...
public:
    ...
    void setupUi(QDialog *RivDataFile)
    {
        ...
        groupBoxButtons->setGeometry(QRect(15, 327, 581, 61));
        ...
        pushButtonClose->setGeometry(QRect(340, 17, 113, 32));
        ...
        textBrowserLogs->setGeometry(QRect(15, 395, 581, 141));
        ...
        groupBoxOutput->setGeometry(QRect(15, 250, 581, 85));
        QFont font2;
        ...
        pushButtonRivDataFile->setGeometry(QRect(475, 10, 98, 32));
        ...
        lineEditRivDataFile->setGeometry(QRect(5, 46, 571, 29));
        QFont font4;
        ...
        groupBoxInput1->setGeometry(QRect(15, 12, 581, 161));
        ...
        pushButtonElementFile->setGeometry(QRect(475, 15, 98, 32));
        ...
        lineEditElementFile->setGeometry(QRect(145, 16, 325, 29));
        ...
        lineEditNodeFile->setGeometry(QRect(145, 50, 325, 29));
        ...
        textLabel1_3->setGeometry(QRect(25, 49, 111, 31));
        ...
        pushButtonNodeFile->setGeometry(QRect(475, 49, 98, 32));
        ...
        lineEditNeighbourFile->setGeometry(QRect(145, 84, 325, 29));
        ...
        textLabel1_4->setGeometry(QRect(25, 83, 111, 31));
        ...
        pushButtonNeighbourFile->setGeometry(QRect(475, 83, 98, 32));
        ...
        lineEditRiverFile->setGeometry(QRect(145, 116, 325, 29));
        ...
        textLabel1_5->setGeometry(QRect(5, 115, 131, 31));
        ...
        pushButtonRiverFile->setGeometry(QRect(475, 116, 98, 32));
        ...
        groupBoxInput2->setGeometry(QRect(15, 180, 581, 71));
