...
/* Maximum number of characters in a file name (including the nullptr).         */
...
/*   is set to nullptr in case a `badsubseg' structure points to it.            */
        ...
        for (j = STARTINDEX; argv[i][j] != '\0'; j++) {
            ...
            if (argv[i][j] == 'q') {
                ...
                if (((argv[i][j + 1] >= '0') && (argv[i][j + 1] <= '9')) ||
                    ...
                    workstring[k] = '\0';
                    b->minangle = (REAL) strtod(workstring, (char **) nullptr);
                } else {
                    b->minangle = 20.0;
                }
            }
            if (argv[i][j] == 'a') {
                ...
                if (((argv[i][j + 1] >= '0') && (argv[i][j + 1] <= '9')) ||
                    ...
                    workstring[k] = '\0';
                    b->maxarea = (REAL) strtod(workstring, (char **) nullptr);
                    if (b->maxarea <= 0.0) {
...
if ((m->nextras > 0) && (*pointattriblist == (REAL *) nullptr)) {
...
if ((m->eextras > 0) && (*triangleattriblist == (REAL *) nullptr)) {
...
if (*vpointattriblist == (REAL *) nullptr) {
...
if (b.poly || b.convex) {
    ...
    if (b.nopolywritten || b.noiterationnum) {
        ...
        if (b.poly) {
            ...
            out->holelist = (REAL *) nullptr;
            out->regionlist = (REAL *) nullptr;
        }
#else /* not TRILIBRARY */
