...
public:
    ...
    void setupUi(QDialog *FillPits)
    {
        ...
        FillPits->resize(800, 420);
        FillPits->setMinimumSize(QSize(800, 420));
        FillPits->setMaximumSize(QSize(800, 420));
        QPalette palette;
        ...
        lineEditDEM->setGeometry(QRect(6, 44, 761, 29));
        QFont font2;
        font2.setPointSize(11);
        font2.setBold(true);
        font2.setWeight(75);
        lineEditDEM->setFont(font2);
        pushButtonDEM = new QPushButton(groupBoxInput);
        pushButtonDEM->setObjectName(QStringLiteral("pushButtonDEM"));
        pushButtonDEM->setGeometry(QRect(664, 10, 98, 32));
        QFont font3;
        font3.setPointSize(12);
        font3.setBold(true);
        font3.setWeight(75);
        pushButtonDEM->setFont(font3);
        ...
        groupBoxOutput->setGeometry(QRect(16, 110, 771, 100));
        ...
        showPF_DFrame->setEnabled(false);
        showPF_DFrame->setGeometry(QRect(676, 75, 91, 21));
        QFont font5;
