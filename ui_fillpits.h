...
public:
    ...
    void setupUi(QDialog *FillPits)
    {
        ...
        groupBoxInput->setGeometry(QRect(17, 17, 581, 91));
        QFont font1;
        ...
        lineEditDEM->setGeometry(QRect(6, 44, 571, 29));
        QFont font2;
        ...
        pushButtonDEM->setGeometry(QRect(480, 10, 98, 32));
        QFont font3;
        ...
        textLabel1->setGeometry(QRect(240, 10, 81, 31));
        ...
        groupBoxOutput->setGeometry(QRect(16, 110, 581, 100));
        ...
        showPF_DFrame->setGeometry(QRect(480, 80, 91, 21));
        QFont font5;
        ...
        lineEditFillPits->setGeometry(QRect(6, 50, 571, 29));
        ...
        textLabel1_2->setGeometry(QRect(230, 10, 111, 31));
