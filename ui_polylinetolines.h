...
public:
    ...
    void setupUi(QDialog *PolylineToLines)
    {
        ...
        pushButtonAdd->setGeometry(QRect(683, 28, 98, 32));
        QFont font1;
        ...
        tableWidget->setGeometry(QRect(15, 19, 661, 171));
        QFont font4;
        ...
        pushButtonRemove->setGeometry(QRect(683, 67, 98, 32));
        ...
        checkBoxSplitLine->setEnabled(false);
        checkBoxSplitLine->setGeometry(QRect(688, 150, 101, 21));
        QFont font5;
        ...
        checkBoxSplitLine->setFont(font5);
        checkBoxSplitLine->setCheckable(false);
        checkBoxSplitLine->setChecked(false);
        pushButtonClear = new QPushButton(groupBoxInput);
        pushButtonClear->setObjectName(QStringLiteral("pushButtonClear"));
        pushButtonClear->setGeometry(QRect(683, 107, 98, 32));
    ...
    void retranslateUi(QDialog *PolylineToLines)
    {
        ...
        groupBoxInput->setTitle(QApplication::translate("PolylineToLines", "Input and Output", nullptr));
