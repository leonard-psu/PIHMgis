...
public:
    ...
    void setupUi(QDialog *PolylineToLines)
    {
        ...
        tableWidget->setGeometry(QRect(15, 19, 451, 171));
        QFont font3;
        ...
        checkBoxSplitLine->setGeometry(QRect(480, 150, 101, 21));
        QFont font4;
        ...
        checkBoxSplitLine->setFont(font4);
        ...
        groupBoxButtons->setGeometry(QRect(15, 233, 581, 51));
        ...
        pushButtonClose->setGeometry(QRect(326, 6, 113, 32));
        ...
        textBrowserLogs->setGeometry(QRect(15, 286, 581, 111));
        QFont font6;
