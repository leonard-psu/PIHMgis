...
public:
    ...
    void setupUi(QDialog *LinkGrids)
    {
        ...
        lineEditFlowDirGrids->setGeometry(QRect(5, 122, 571, 29));
        ...
        pushButtonFlowDirGrids->setGeometry(QRect(480, 86, 98, 32));
        ...
        textLabel1_3->setGeometry(QRect(240, 86, 111, 31));
        ...
        groupBoxButtons->setGeometry(QRect(15, 300, 581, 51));
