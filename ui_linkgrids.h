...
public:
    ...
    void setupUi(QDialog *LinkGrids)
    {
        ...
        LinkGrids->resize(800, 480);
        LinkGrids->setMinimumSize(QSize(800, 480));
        LinkGrids->setMaximumSize(QSize(800, 480));
        QPalette palette;
        ...
        pushButtonStreamGrids->setGeometry(QRect(666, 10, 98, 32));
        QFont font2;
        font2.setPointSize(12);
        font2.setBold(true);
        font2.setWeight(75);
        pushButtonStreamGrids->setFont(font2);
        ...
        textLabel1->setGeometry(QRect(310, 10, 101, 31));
        ...
        lineEditStreamGrids->setGeometry(QRect(4, 46, 761, 29));
        QFont font3;
        font3.setPointSize(11);
        font3.setBold(true);
        font3.setWeight(75);
        lineEditStreamGrids->setFont(font3);
        lineEditFlowDirGrids = new QLineEdit(groupBoxInput);
        lineEditFlowDirGrids->setObjectName(QStringLiteral("lineEditFlowDirGrids"));
        lineEditFlowDirGrids->setGeometry(QRect(5, 122, 761, 29));
        ...
        pushButtonFlowDirGrids->setGeometry(QRect(666, 86, 98, 32));
        ...
        textLabel1_3->setGeometry(QRect(303, 86, 111, 31));
        ...
        groupBoxInput_2->setGeometry(QRect(15, 184, 771, 111));
        groupBoxInput_2->setFont(font1);
        textLabel1_2 = new QLabel(groupBoxInput_2);
        textLabel1_2->setObjectName(QStringLiteral("textLabel1_2"));
        textLabel1_2->setGeometry(QRect(320, 10, 90, 31));
        ...
        pushButtonLinkGrids->setGeometry(QRect(666, 12, 98, 32));
        ...
        lineEditLinkGrids->setGeometry(QRect(4, 47, 761, 29));
        ...
        checkBoxLinkGrids->setEnabled(false);
        checkBoxLinkGrids->setGeometry(QRect(676, 80, 91, 21));
        QFont font5;
        ...
        checkBoxLinkGrids->setFont(font5);
        checkBoxLinkGrids->setCheckable(false);
        checkBoxLinkGrids->setChecked(false);
        groupBoxButtons = new QGroupBox(LinkGrids);
        groupBoxButtons->setObjectName(QStringLiteral("groupBoxButtons"));
        groupBoxButtons->setGeometry(QRect(15, 293, 771, 51));
