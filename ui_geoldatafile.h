...
public:
    ...
    void setupUi(QDialog *GeolDataFile)
    {
        ...
        pushButtonGeolDataFile->setGeometry(QRect(675, 10, 98, 32));
        pushButtonGeolDataFile->setFont(font1);
        ...
        lineEditGeolDataFile->setGeometry(QRect(3, 45, 771, 29));
        QFont font2;
        font2.setPointSize(11);
        font2.setBold(true);
        font2.setWeight(75);
        lineEditGeolDataFile->setFont(font2);
        ...
        pushButtonGeolTextureFile->setGeometry(QRect(678, 10, 98, 32));
        pushButtonGeolTextureFile->setFont(font1);
        ...
        textLabel1->setGeometry(QRect(332, 10, 111, 31));
        ...
        lineEditGeolTextureFile->setGeometry(QRect(4, 44, 771, 29));
        lineEditGeolTextureFile->setFont(font2);
        groupBoxButtons = new QGroupBox(GeolDataFile);
        groupBoxButtons->setObjectName(QStringLiteral("groupBoxButtons"));
        groupBoxButtons->setGeometry(QRect(5, 179, 781, 51));
