...
public:
    ...
    void setupUi(QDialog *SimplifyPolylines)
    {
        ...
        checkBoxSimplifyPolylines->setFont(font4);
        checkBoxSimplifyPolylines->setCheckable(false);
    ...
    void retranslateUi(QDialog *SimplifyPolylines)
    {
        ...
        groupBoxInput->setTitle(QApplication::translate("SimplifyPolylines", "Input and Output", nullptr));
