...
public:
    ...
    void setupUi(QDialog *SoilDataFile)
    {
        ...
        groupBoxButtons->setGeometry(QRect(15, 190, 581, 41));
        ...
        textLabel2->setGeometry(QRect(190, 10, 131, 31));
        QFont font3;
        ...
        pushButtonSoilDataFile->setGeometry(QRect(478, 10, 98, 32));
        ...
        lineEditSoilDataFile->setGeometry(QRect(5, 42, 571, 29));
        QFont font4;
        ...
        pushButtonSoilTextureFile->setGeometry(QRect(477, 10, 98, 32));
        ...
        textLabel1->setGeometry(QRect(200, 10, 111, 31));
        ...
        lineEditSoilTextureFile->setGeometry(QRect(6, 46, 571, 29));
