...
public:
    ...
    void setupUi(QDialog *CatchmentGrids)
    {
        ...
        pushButtonCatchmentGrids->setGeometry(QRect(480, 10, 98, 32));
        ...
        lineEditCatchmentGrids->setGeometry(QRect(10, 50, 561, 29));
        QFont font2;
        font2.setPointSize(14);
        font2.setBold(true);
        font2.setWeight(75);
        lineEditCatchmentGrids->setFont(font2);
        ...
        checkBoxCatchmentGrids->setGeometry(QRect(490, 80, 101, 21));
        QFont font3;
        ...
        checkBoxCatchmentGrids->setFont(font3);
        ...
        pushButtonLinkGrids->setGeometry(QRect(480, 10, 98, 32));
        ...
        lineEditLinkGrids->setGeometry(QRect(4, 53, 571, 29));
        lineEditLinkGrids->setFont(font2);
        lineEditFlowDirGrids = new QLineEdit(groupBoxInput);
        lineEditFlowDirGrids->setObjectName(QStringLiteral("lineEditFlowDirGrids"));
        lineEditFlowDirGrids->setGeometry(QRect(10, 126, 561, 29));
        ...
        textLabel1_3->setGeometry(QRect(230, 90, 111, 31));
