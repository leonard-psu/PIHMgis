...
public:
    ...
    void setupUi(QDialog *TINShapeLayer)
    {
        ...
        groupBoxButtons->setGeometry(QRect(15, 312, 581, 51));
        pushButtonHelp = new QPushButton(groupBoxButtons);
        pushButtonHelp->setObjectName(QStringLiteral("pushButtonHelp"));
        pushButtonHelp->setEnabled(false);
        pushButtonHelp->setGeometry(QRect(16, 6, 113, 32));
        QFont font1;
        ...
        groupBoxInput_2->setGeometry(QRect(15, 195, 581, 111));
        QFont font2;
        ...
        lineEditTINFile->setGeometry(QRect(10, 50, 561, 29));
        QFont font5;
        ...
        checkBoxTINFile->setGeometry(QRect(480, 80, 91, 21));
        QFont font6;
        ...
        textBrowserLogs->setGeometry(QRect(15, 367, 581, 91));
        ...
        textLabel1_3->setGeometry(QRect(250, 90, 87, 31));
