...
public:
    ...
    void setupUi(QDialog *StreamPolyline)
    {
        ...
        lineEditFlowDirGrids->setGeometry(QRect(10, 130, 561, 29));
        ...
        textLabel1_3->setGeometry(QRect(230, 90, 87, 31));
        ...
        textLabel1_2->setGeometry(QRect(220, 10, 111, 31));
        ...
        lineEditStreamPolyline->setGeometry(QRect(4, 48, 571, 29));
        lineEditStreamPolyline->setFont(font1);
        ...
        checkBoxStreamPolyline->setGeometry(QRect(490, 80, 91, 21));
        QFont font2;
        ...
        checkBoxStreamPolyline->setFont(font2);
